...
export default function ApiBuilderEdit({ apiData, apiId }: ApiBuilderEditProps) {
  ...
  const [includeHandwriting, setIncludeHandwriting] = useState(apiData.definition.includeHandwriting || false)
  const [responseLanguage, setResponseLanguage] = useState(apiData.definition.responseLanguage || "english")
